...
7. Не бояться просить помощи во всех доступных источниках, если пришлось столкнуться с проблемой, которую не получается
решить за вменяемое время.
8. Если учеба "не лезет" - стоит сделать небольшой перерыв
...
## Python:
1. [Что такое интерпретируемый язык?](<./0 Python/0 Введение.md#что-такое-интерпретируемый-язык>) [Что такое интерпретатор и как он работает в Python?](<./0 Python/0 Введение.md#что-такое-интерпретатор-и-как-он-работает-в-python>)
2. [Что такое файлы .pyc и зачем они нужны?](<./0 Python/0 Введение.md#что-такое-файлы-pyc-и-зачем-они-нужны>)
3. [Что такое статическая и динамическая типизация и в чем это проявляется в Python?](<./0 Python/1 Типы данных/0 Введение.md#что-такое-статическая-и-динамическая-типизация-и-в-чем-это-проявляется-в-python>)
4. [Какие типы данных в Python вам известны?](<./0 Python/1 Типы данных/0 Введение.md#какие-типы-данных-в-python-вам-известны>)
5. [Как реализован под капотом питоновский список?](<./0 Python/1 Типы данных/Изменяемые/Списки.md#как-реализован-под-капотом-список>)
6. [Чем кортеж отличается от списка?](<./0 Python/1 Типы данных/Неизменяемые/Кортежи.md#что-такое-кортеж>)
7. [В каких случаях лучше использовать кортеж, а в каких - список?](<./0 Python/1 Типы данных/Неизменяемые/Кортежи.md#в-каких-случаях-лучше-использовать-кортеж-а-в-каких-список>)
8. Как вы объясните человеку, [что такое множество](<./0 Python/1 Типы данных/Изменяемые/Множества.md#что-такое-множество>)?
9. [Что такое словари](<./0 Python/1 Типы данных/Изменяемые/Словари.md#что-такое-словарь>) и [как они работают](<./0 Python/1 Типы данных/Изменяемые/Словари.md#как-реализован-под-капотом-словарь>)?
10. Как работают типы данных [хэшмап](<./0 Python/1 Типы данных/Изменяемые/Словари.md#как-реализован-под-капотом-словарь>), [связанный список](<./1 Алгоритмы/0 Структуры данных/1 Связанные и двусвязные списки.md#как-работает-связанный-список>), [двусвязный список](<./1 Алгоритмы/0 Структуры данных/1 Связанные и двусвязные списки.md#как-работает-двусвязный-список>), [массив](<./1 Алгоритмы/0 Структуры данных/0 Массивы.md#как-работает-массив>)?
11. [Что такое О (о-большое)? Зачем и как используется?](<./0 Python/1 Типы данных/1 Сложность операций.md#что-такое-о-о-большое-зачем-и-как-используется>)
12. [Какая сложность вставки, извлечения, поиска элементов в словаре и списке?](<./0 Python/1 Типы данных/1 Сложность операций.md#какая-сложность-основных-операций-в-списках-массивах-словарях-и-множествах-хэшмапах>)
